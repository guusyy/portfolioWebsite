...
For each tool there can be components added: eg. sliders to help bringing the message throught interaction.

Through authentication we make sure the different fire departments can have a personlized view of only the tools that are within their department.
...
For demo purposes for this portfolio you can make use of these credentials:
